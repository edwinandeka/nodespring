...
var ExpressApp = function (_NodeSpringApp) {
  ...
  function ExpressApp(config) {
    ...
    var _this = _possibleConstructorReturn(this, (ExpressApp.__proto__ || Object.getPrototypeOf(ExpressApp)).call(this, config));
  ...
  _createClass(ExpressApp, [{
    ...
    value: function configExpressApp() {
      ...
      if (this.config.https) {
        this.server = _https2.default.createServer(this.config.https, this.expressApp);
      } else {
