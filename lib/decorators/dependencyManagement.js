...
function Implements(type) {
  var scope = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : Scope.SINGLETON;
...
function Interface(interfaceBase) {
  ...
  var MockedInterface = (_temp = _class = function (_Abstract) {
    ...
    function MockedInterface() {
      ...
      return _possibleConstructorReturn(this, (MockedInterface.__proto__ || Object.getPrototypeOf(MockedInterface)).call(this));
    }
